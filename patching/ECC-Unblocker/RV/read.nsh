...
# setup_var.efi AmdSetup(0x5000):0xA1 > result
# dmpstor -l result enable_overclock
# echo Enable Memory Overclock: AmdSetup(0x5000):0xA1=%enable_overclock%
echo Enable Memory Overclock Setting:
setup_var.efi AmdSetup(0x5000):0xA1
echo Expected AmdSetup(0x5000):0xA1=0x01
echo ...................................................................
...
# setup_var.efi AmdSetup(0x5000):0xE2 > result
# dmpstor -l result enable_ecc_memory
# echo Enable Overclock: AmdSetup(0x5000):0xE2=%enable_ecc_memory%
echo Enable ECC Memory Setting:
setup_var.efi AmdSetup(0x5000):0xE2
echo Expected AmdSetup(0x5000):0xE2=0x01
echo ...................................................................
