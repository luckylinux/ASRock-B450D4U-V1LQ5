...
# setup_var.efi AmdSetup(0x5000):0x4A > result
...
setup_var.efi AmdSetup(0x5000):0x4A
echo Expected AmdSetup(0x5000):0x4A=0x01
echo ...................................................................
...
# setup_var.efi AmdSetup(0x5000):0x91 > result
# dmpstor -l result enable_ecc_memory
# echo Enable Overclock: AmdSetup(0x5000):0x91=%enable_ecc_memory%
echo Enable ECC Memory Setting:
setup_var.efi AmdSetup(0x5000):0x91
echo Expected AmdSetup(0x5000):0x91=0x01
echo ...................................................................
